...
<title>Letovi u intervalu</title>
</head>
...
<body>
	...
	<form method="post"
		action="${pageContext.servletContext.contextPath}/mvc/letovi/letoviInterval">
		<label for="icao">ICAO:</label> <input type="text" name="icao"
			id="icao" value="${icao}"> <br> <label for="datumOd">Datum
			od:</label> <input type="text" name="datumOd" id="datumOd" value="${datumOd}">
		<br> <label for="datumDo">Datum do:</label> <input type="text"
			name="datumDo" id="datumDo" value="${datumDo}"> <br>
	...
	<div class="post-gumbi">
		<form method="post"
			action="${pageContext.servletContext.contextPath}/mvc/letovi/letoviInterval">
			<input hidden="" type="text" name="icao" id="icao" value="${icao}">
			<input hidden="" type="text" name="datumOd" id="datumOd"
				value="${datumOd}"> <input hidden="" type="text"
				name="datumDo" id="datumDo" value="${datumDo}"> <input
