...
<body>
	...
	<form method="post"
		action="${pageContext.servletContext.contextPath}/mvc/letovi/letoviDatum">
	...
	<div class="post-gumbi">
		<form method="post"
			...
			<input hidden="" type="text" name="datum" id="datum" value="${datum}"><input
		...
		<form method="post"
			action="${pageContext.servletContext.contextPath}/mvc/letovi/letoviDatum">
			<input hidden="" type="text" name="icao" id="icao" value="${icao}">
			<input hidden="" type="text" name="datum" id="datum" value="${datum}">
			<input hidden="" type="text" name="stranica" id="stranica">
