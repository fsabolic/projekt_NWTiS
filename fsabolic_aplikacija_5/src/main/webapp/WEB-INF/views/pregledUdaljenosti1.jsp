...
<body>
	...
	<form method="POST"
		action="${pageContext.servletContext.contextPath}/mvc/aerodromi/pregledUdaljenosti1">
	...
	<p>
		<strong>Ukupna udaljenost: </strong>${ukupnaUdaljenost}</p>
	<%
	}
	%>
</body>
