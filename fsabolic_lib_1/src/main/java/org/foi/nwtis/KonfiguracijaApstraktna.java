...
import org.foi.nwtis.fsabolic.konfiguracije.KonfiguracijaBin;
import org.foi.nwtis.fsabolic.konfiguracije.KonfiguracijaJson;
import org.foi.nwtis.fsabolic.konfiguracije.KonfiguracijaTxt;
import org.foi.nwtis.fsabolic.konfiguracije.KonfiguracijaXml;
import org.foi.nwtis.fsabolic.konfiguracije.KonfiguracijaYaml;
...
public abstract class KonfiguracijaApstraktna implements Konfiguracija {
  ...
  /**
   * Sprema postavku ako postoji
   * 
   * @param kljuc - naziv postavke
   * @param vrijednost - vrijednost postavke
   * @return vraca true ako je postavka dodana ili false ako postoji
   ...
   * @param kljuc - naziv postavke
   * @param vrijednost - vrijednost postavke
   * @return vraca true ako je postavka ažurirana ili false ako postavka ne postoji
  ...
  /**
   * Provjerava ima li kakve postavke u memoriji.
   */
  @Override
